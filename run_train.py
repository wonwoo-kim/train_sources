...
def parse_args():
    ...
    parser.add_argument('--trainDB_path', type=str, default='D:/train2014/train2014/',
                        help='The directory where MSCOCO DB was saved')
    parser.add_argument('--style', type=str, default='style/wave.jpg',
    ...
    #D:/00100D_EO.jpg
    parser.add_argument('--test', type=str, default='D:/00100D_EO.jpg',
