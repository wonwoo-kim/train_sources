...
def parse_args():
    ...
    parser.add_argument('--style_model', type=str, default='D:/frozen-pb-master/final.ckpt', help='location for model file (*.ckpt)')

    parser.add_argument('--content', type=str, default='D:/00100D_EO.jpg',
                        help='File path of content image (notation in the paper : x)')

    parser.add_argument('--output', type=str, default='D:/result.jpg',
